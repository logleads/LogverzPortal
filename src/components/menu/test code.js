(function(d, c) {
    var a = "2f546c30ad8d4b80838351c12a4786b1";
    ...
    try {
        if (!c.reviveAsync.hasOwnProperty(a)) {
            var f = c.reviveAsync[a] = {
                ...
                apply: function(g) {
                    if (g.zones.length) {
                        var e = "http:" === d.location.protocol ? "http://adserver.logleads.com/www/delivery/asyncspc.php" : "https://adserver.logleads.com/www/delivery/asyncspc.php";
